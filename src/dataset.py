...
class CharCorruptionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        masked_string = prefix + self.MASK_CHAR + suffix + self.MASK_CHAR + masked_content + self.PAD_CHAR*(self.block_size-(entry_len+2)+10)
...
if __name__ == '__main__':
    ...
    if args.dataset_type == 'namedata':
        ...
        # corruption_dataset = CharCorruptionDataset(codecs.open('wiki.txt', "r", encoding='utf-8').read(), 128)
        corruption_dataset = CharCorruptionDataset(open('wiki.txt', encoding='utf-8').read(), 128)
        # print("corruption_dataset", corruption_dataset.itos)
